...
public class UsersRecyclerAdapter extends RecyclerView.Adapter<UsersRecyclerAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.textEmail.setText("Price : " + users.getUserEmail());
        holder.textCountry.setText("Quantity : " + users.getUserCountry());
                ...
                public void onClick(View view) {
                    ...
                    if (name.isEmpty() || email.isEmpty() || country.isEmpty()) {
                        ...
                        if (newName.equals(name) && newEmail.equals(email) && newCountry.equals(country)) {
                            ...
                            Toast.makeText(context, "User Updated Item!", Toast.LENGTH_SHORT).show();
                            dialog.dismiss();
                        }
